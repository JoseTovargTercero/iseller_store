...
class Cart
{
	...
	public function modificar_cantidad($accion, $row_id)
	{
		if (!isset($this->cart_contents[$row_id])) {
			return FALSE;
		}

		$item = $this->cart_contents[$row_id];
		$cantidad_actual = $item['qty'];
